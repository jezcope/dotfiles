...
*** Function keys
  ...
  +-------+-------+------+------+--------+----------+------+--------+------+-------+------+------+------+
  |       |Org    |Org   |Macro |Macro   |Activate  |Magit |Org     |mu4e  |Toggle |Menu  |      |      |
  |       |capture|agenda|record|call/end|ECB       |status|velocity|      |sunrise|      |      |      |
  +-------+-------+------+------+--------+----------+------+--------+------+-------+------+------+------+
  | Ctrl  |Open   |      |      |        |Deactivate|      |        |      |       |      |      |      |
  |       |inbox  |      |      |        |ECB       |      |        |      |       |      |      |      |
  +-------+-------+------+------+--------+----------+------+--------+------+-------+------+------+------+
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "<f7>") 'org-velocity-read)
