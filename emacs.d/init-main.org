...
#+BEGIN_SRC emacs-lisp
  (setq org-directory (expand-file-name "~/Notes/Todo")
...
#+BEGIN_SRC emacs-lisp
  (use-package projectile
    ...
    (defhydra jc/projectile-hydra (:color blue :columns 4)
      ...
      ("ss" counsel-projectile-rg "ripgrep")
      ("sr" counsel-projectile-rg "ripgrep")
      ("sa" counsel-ag-projectile "ag")
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'ispell-local-dictionary-alist '("british"
                                                "[[:alpha:]]"
                                                "[^[:alpha:]]"
                                                "[']"
                                                t
