...
#+BEGIN_SRC emacs-lisp
  (defun jc/first-available-font (stack)
    (loop for f in stack
          if (member f (font-family-list))
          do (return f)))

  (setq jc/font-fixed
        (jc/first-available-font '("Input Mono Condensed"
                                   "Inconsolata"
                                   "Droid Sans Mono"
                                   "Ubuntu Mono"
                                   "Menlo"
        ...
        jc/font-variable
        (jc/first-available-font '("Input Sans Condensed"
                                   "Droid Sans"
                                   "Ubuntu Sans"
                                   "sans"))
        )

  (when (not (null jc/font-fixed))
    (set-face-font 'default jc/font-fixed))
  (set-face-attribute 'default nil
                      :height 100
                      :width 'condensed
                      :weight 'light)

  (when (not (null jc/font-variable))
    (set-face-font 'variable-pitch jc/font-variable))
