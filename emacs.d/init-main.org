...
#+BEGIN_SRC emacs-lisp
  (when (member "FontAwesome" (font-family-list))
    (diminish 'auto-fill-function (concat " " [#xF039] "A"))
    (diminish 'visual-line-mode   (concat " " [#xF039] "V"))
    (diminish 'auto-complete-mode (concat " " [#xF054]))
    (diminish 'filladapt-mode     (concat " " [#xF03C]))
