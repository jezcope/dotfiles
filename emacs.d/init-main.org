...
#+BEGIN_SRC emacs-lisp
  ...
  ^perspectives^   ^windows^           ^split^
  ^^^^^^-------------------------------------------------
  _n_: next        _o_: next           _%_: horizontally
  _p_: previous    _O_: previous       _\"_: vertically
  _w_: select      _J_: jump
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package markdown-mode
    ...
    (add-hooks-pair '(markdown-mode-hook gfm-mode-hook) jc/markdown-minor-modes)
